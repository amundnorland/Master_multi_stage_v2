...
read_all_sheets('Test_data.xlsx')
...
"""
#Declaring Variables
model.x_UP = pyo.Var(model.Nodes, model.Time, domain= pyo.NonNegativeReals, bounds=(0,1000))
model.x_DWN = pyo.Var(model.Nodes, model.Time, domain= pyo.NonNegativeReals, bounds=(0,1000))
...
model.x_DA_Up = pyo.Var(model.Nodes, model.Time, domain= pyo.NonNegativeReals, bounds=(0,1000))
model.x_DA_Dwn = pyo.Var(model.Nodes, model.Time, domain= pyo.NonNegativeReals, bounds=(0,1000))
model.x_ID_Up = pyo.Var(model.Nodes, model.Time, domain= pyo.NonNegativeReals, bounds=(0,1000))
model.x_ID_Dwn = pyo.Var(model.Nodes, model.Time, domain= pyo.NonNegativeReals, bounds=(0,1000))
...
model.LoadShiftingWindow = pyo.Constraint(model.Nodes_RT, model.LoadShiftingIntervals, model.ShiftableLoadForEnergyCarrier, rule=loads_shifting_time_window)
...
def no_discharge_outside_load_shift(model, n, t, b, e):
    if not any(t == load_t[1] for load_t in model.TimeLoadShift):
        ...
        return pyo.Constraint.Skip
model.NoDischargeOutsideLoadShift = pyo.Constraint(model.Nodes_RT, model.Time, model.ShiftableLoadForEnergyCarrier, rule=no_discharge_outside_load_shift)
...
def no_charge_outside_load_shift(model, n, t, b, e):
    if not any(t == load_t[1] for load_t in model.TimeLoadShift):
        ...
        return pyo.Constraint.Skip
model.NochargeOutsideLoadShift = pyo.Constraint(model.Nodes_RT, model.Time, model.ShiftableLoadForEnergyCarrier, rule=no_charge_outside_load_shift)
...
model.DayAheadToIntradayUp = pyo.Constraint(model.Parent_Node, model.Time, rule = Reserve_Capacity_Up_NA) 
